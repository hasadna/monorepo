...
http_archive(
    name = "startup_os",
    strip_prefix = "startup-os-620b4be02440e5d241299109e0a8fd85d73ccd1c",
    urls = ["https://github.com/google/startup-os/archive/620b4be02440e5d241299109e0a8fd85d73ccd1c.zip"],
)
# MARK: StartupOS end
