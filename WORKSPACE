...
http_archive(
    name = "gtfs_data",
    build_file_content = 'exports_files(["agency.txt", "calendar.txt", "samples.txt","fare_attributes.txt", "fare_rules.txt", "routes.txt", "shapes.txt", "stop_times.txt", "stops.txt", "translations.txt", "trips.txt"])',
