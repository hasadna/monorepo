...
http_archive(
    name = "startup_os",
    strip_prefix = "startup-os-3deea43a7e0d8871104d0c7ec9ebc03ee63b64a1",
    urls = ["https://github.com/google/startup-os/archive/3deea43a7e0d8871104d0c7ec9ebc03ee63b64a1.zip"],
)
# MARK: StartupOS end
