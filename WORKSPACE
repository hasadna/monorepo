...
http_archive(
    name = "startup_os",
    strip_prefix = "startup-os-96864a8a5325476ba405b740f0750a98b6961b3f",
    urls = ["https://github.com/google/startup-os/archive/96864a8a5325476ba405b740f0750a98b6961b3f.zip"],
)
# MARK: StartupOS end
