...
/** To build: bazel build //projects/avodata:ls-alg_tool To run: bazel-bin/projects/avodata/ls-alg_tool */
/** This class reads matrix from csv file, ignores the parmeters and calculate 
/** using least squares */
public class AvodataSolverTool {

  static final String fpath = "/projects/avodata/check.csv";
  ...
  public static double[][] buildCheck(
  ...
  public static RealMatrix readMatrixAndCreate() {
    ...
    try {
      scanner = new Scanner(new File(myPath + fpath));
