...
public class MainActivity extends AppCompatActivity
    ...
    public void onFetched(){
        ...
        if (messageCount == 0) {
            summaryTextView.setText(getResources()
                .getString(R.string.content_summary_empty));
            lawsuitLayout.setVisibility(View.GONE);
        } else {
            summaryTextView.setText(Html.fromHtml(getResources().getString(
                R.string.content_summary, String.valueOf(messageCount))));
