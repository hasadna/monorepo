...
public class MessagesAdapter
    ...
    public class SummaryViewHolder extends RecyclerView.ViewHolder {
        ...
        SummaryViewHolder(View itemView) {
            ...
            Spanned spanned = Html.fromHtml(context.getResources().getString(R.string.text_lawsuit), Html.FROM_HTML_MODE_COMPACT);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder,
        ...
        switch (holder.getItemViewType()) {
            case 0: // summary
                ...
                viewHolder.textView.setText(Html.fromHtml(context.getResources().getString(
                        R.string.content_summary, String.valueOf(messagesCount))));
                break;
            case 1:
                SmsMessage message = messages.get(position);
                ItemViewHolder itemViewHolder = (ItemViewHolder) holder;
                itemViewHolder.fromText.setText(context.getResources()
                        .getString(R.string.list_item_title, message.getSender()));
